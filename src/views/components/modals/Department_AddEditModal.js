...
export default function Department_AddEditModal({ master, updateFormData }) {
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content rounded shadow border-0">
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            ...
                                            <div className="form-icon position-relative">
                                                ...
                                                <input name="name" id="name" type="text" className="form-control ps-5" placeholder="Department Name :" onChange={updateFormData} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="modal-footer">
                        <button type="submit" id="btnSubmit" className="btn btn-primary" data-bs-dismiss="modal">Add Department</button>
                    </div>
                </div>
            </div>
        </div>
