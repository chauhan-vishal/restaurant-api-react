...
export default function Role_AddEditModal({ master, updateFormData }) {
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content rounded shadow border-0">
                        ...
                        <form method='POST' encType="multipart/form-data">
                            <div className="bg-white rounded box-shadow" style={{ textAlign: "left", padding: "0px !important", fontSize: "1.2rem" }}>
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            ...
                                            <div className="form-icon position-relative">
                                                ...
                                                <input name="name" id="name" type="text" className="form-control ps-5" placeholder="Role Name:" onChange={updateFormData} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            <label className="form-label">Descripition <span className="text-danger">*</span></label>
                                            <div className="form-icon position-relative">
                                                <i data-feather="user" className="fea icon-sm icons"></i>
                                                <input name="desc" id="desc" type="text area" className="form-control ps-5" placeholder="Description of Role" onChange={updateFormData} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="modal-footer">
                        <button type="submit" id="btnSubmit" className="btn btn-primary" data-bs-dismiss="modal">Add Role</button>
                    </div>
                </div>
            </div>
        </div>
