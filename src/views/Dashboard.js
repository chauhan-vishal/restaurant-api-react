...
export default function Dashboard({ role, setActiveMenu }) {
						...
						(role == "Admin")
							? (
								<>
									...
									<div className="col mt-4" style={{ wordBreak: "break-all" }} onClick={() => { setActiveMenu('/Order') }}>
										<NavLink to="/Order" className="features feature-primary d-flex justify-content-between align-items-center bg-white rounded shadow p-3">
											<div className="d-flex align-items-center">
												<div className="icon text-center rounded-pill">
													<i className="ti ti-home me-2 fs-4 mb-0"></i>
												</div>
												<div className="flex-1 ms-3">
													...
													<p className="fs-5 text-dark fw-bold mb-0"><span className="counter-value" data-target="4589">{counts.orders}</span></p>
												</div>
											</div>
										</NavLink>
									</div>
								...
								<>
									<div className="col mt-4" style={{ wordBreak: "break-all" }} onClick={() => { setActiveMenu('/Kiosk') }}>
										<NavLink to="/Kiosk" className="features feature-primary d-flex justify-content-between align-items-center bg-white rounded shadow p-3">
											<div className="d-flex align-items-center">
												<div className="icon text-center rounded-pill">
													<i className="ti ti-home me-2 fs-4 mb-0"></i>
												</div>
												<div className="flex-1 ms-3">
													<h6 className="mb-0 text-muted">Kiosk</h6>
													<p className="fs-5 text-dark fw-bold mb-0"><span className="counter-value" data-target="4589">{counts.kiosk}</span></p>
												</div>
											</div>
										</NavLink>
									</div>
